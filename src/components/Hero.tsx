...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-mint-50 via-white to-lavender-50"></div>
      
      {/* Floating elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-mint-200 rounded-full opacity-30 animate-bounce-gentle"></div>
      <div className="absolute top-40 right-20 w-16 h-16 bg-lavender-200 rounded-full opacity-30 animate-bounce-gentle" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-sage-200 rounded-full opacity-30 animate-bounce-gentle" style={{ animationDelay: '2s' }}></div>
